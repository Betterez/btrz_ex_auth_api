if Code.ensure_loaded?(Plug) do
  defmodule BtrzAuth.Plug.VerifyHeaderInternal do
    ...
    * `key` - The location to store the information in the connection. Defaults to: `default`
    ...
    def init(opts \\ []) do
      opts = Keyword.put(opts, :main_secret, Keyword.get(Application.get_env(:btrz_auth, BtrzAuth.GuardianInternal), :main_secret, ""))
      opts = Keyword.put(opts, :secondary_secret, Keyword.get(Application.get_env(:btrz_auth, BtrzAuth.GuardianInternal), :secondary_secret, ""))
